...
CREATE TABLE `contractcategory` (
  `ContractCategoryId` int(11) NOT NULL AUTO_INCREMENT,
  `ContractCategoryName` varchar(255) NOT NULL,
  PRIMARY KEY (`ContractCategoryId`)
...
INSERT INTO `contractcategory` VALUES (5,'serv');
